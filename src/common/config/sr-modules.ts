...
// we should have list of types somethere and compare with modules list from staking router
// if Keys API doesnt know how to work with some module we should throw error and stop
export const srModules = {
  [CHAINS.Mainnet]: [
    {
      id: 1,
