...
export class Migration20230724192156 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "consensus_validator" alter column "pubkey" type varchar(255) using ("pubkey"::varchar(255));');
    this.addSql('alter table "consensus_validator" alter column "status" type varchar(255) using ("status"::varchar(255));');
